            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-4xl mx-auto p-4">
                    ...
                    {chapters.map((chapter, chapterIndex) => (
                        <ChapterCreator key={chapter.id} chapter={chapter} chaptersLength={chapters.length} chapterIndex={chapterIndex} removeChapter={removeChapter} form={form}/>
                    ))}

                    <Button onClick={() => appendChapter({
                    ...
                    })} variant="outline" className="w-full flex items-center justify-center"
                            type="button">
